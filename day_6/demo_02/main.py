...
#create model 
llm=init_chat_model(model="google/gemma-3-4b",
...
agent=create_agent(
    ...
    system_prompt="You are a helpful assistent. Give correct answer. If you use any tool, then explain answer in understandable form "
)
